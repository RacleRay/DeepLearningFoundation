...
class CoraData:
    ...
    def __init__(self, data_root="cora", rebuild=False):
        ...
        Cora数据: 2708篇论文的词袋表示（1433维），主题分为7类，相关关系为5429条边组成。
                  任务为节点分类，预测论文的主题。
    ...
    def process_data(self):
        ...
        return Data(x=x, y=y, adjacency_dict=adjacency,
    ...
    def build_adjacency(adj_dict):
        ...
        for i, row in enumerate(adj):
            adj_dict[i] = np.argwhere(row).squeeze()
        return adj_dict
