...
from image_loader import BatchGenerator
from boundbox import draw_boxes
from yolo_v3 import Yolonet
from yolo_loss import loss_fn

tf.enable_eager_execution()  # tf 1.1x
...
#定义预训练模型路径
YOLOV3_WEIGHTS = os.path.join(PROJECT_ROOT, "model/yolov3.weights")
#定义分类
