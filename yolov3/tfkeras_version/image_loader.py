...
from boundbox import find_match_box
from annotation_parse import parse_annotation
from image_aug import ImgAugment
...
class BatchGenerator(object):
    def __init__(self, ann_fnames, img_dir,labels,
        ...
        self.jitter = jitter
        self.anchors = create_anchor_boxes(anchors)#按照anchors的尺寸，生成从 0 0 坐标开始的框
